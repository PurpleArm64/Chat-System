...
// GLOBAL LOGOUT TIMESTAMP FOR OFFLINE USERS
...
// UPDATED CONFIG ENDPOINT FOR GLOBAL LOGOUT CHECK
...
// UPDATED LOGOUT ALL ENDPOINT FOR GLOBAL LOGOUT
app.post('/api/admin/logout-all', async (req, res) => {
    ...
    try {
        ...
        // Set global logout timestamp for offline users
