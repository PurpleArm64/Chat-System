...
app.post('/api/register', async (req, res) => {
    ...
    try {
        ...
        console.log(`✅ Register OK [${username}] ${Date.now() - t0}ms`);
...
app.post('/api/login', async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            console.log(`❌ Login fail [${username}] ${Date.now() - t0}ms`);
        ...
        console.log(`✅ Login OK [${user.username}] ${Date.now() - t0}ms`);
...
const SHORT_CATEGORIES = {
    trending: { q: 'shorts viral Instagram reel' },
    aesthetic: { q: 'shorts kdrama edit' },
