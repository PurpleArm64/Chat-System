...
const GOOGLE_CLIENT_ID = process.env.GOOGLE_CLIENT_ID || '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.apps.googleusercontent.com';
...
io.on('connection', (socket) => {
    ...
    socket.on('send_message', async ({ from, to, text, type, media }) => {
        try {
            ...
            const msg = { from, to, text: text || '', type: type || 'text', media: media || null, timestamp: Date.now(), delivered: toOnline, read: false };
