...
const SHORT_CATEGORIES = {
    ...
    aesthetic:   { q: 'shorts Instagram sad' },
    love:        { q: 'shorts couple goals romantic' },
    sad:         { q: 'shorts sad status quotes hindi' },
    attitude:    { q: 'Shorts Kdrama Hindi'},
    dance:       { q: 'shorts dance trending viral reel' },
    meme:        { q: 'shorts funny meme comedy trending' },
    indian:      { q: 'shorts love status video song' },
    bangla:      { q: 'shorts bangla status video song romantic' },
    korean:      { q: 'shorts korean aesthetic edit' },
    romantic:    { q: 'shorts romantic couple love edit' },
    whatsapp:    { q: 'shorts tiktok status video love' },
    edit:        { q: 'shorts instagram music singer' },
