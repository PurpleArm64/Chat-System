...
app.get('/api/messages', async (req, res) => {
    try {
        ...
        .sort({ timestamp: 1 })   // ascending — UI সরাসরি render করবে
        .toArray();
...
app.get('/api/admin/stats', async (req, res) => {
    ...
    try {
        ...
        res.json({ totalUsers, onlineCount, totalMsgs, totalStories, totalReels, totalFriendships, totalMusic, msgsToday, newUsersToday });
